...
import com.exemplo.springboot_jpa_workshop.services.exceptions.DatabaseException;
...
public class ResourceExceptionHandler {
    ...
    @ExceptionHandler(DatabaseException.class) // interceptar a requisição que gerou a exceção
